...
import { ArrowRight, FileText, Zap, Printer, Shield } from "lucide-react";
...
export function LandingHero() {
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-white">
      {/* Gradient background */}
      ...
      />
      {/* Dark-mode grid (separate so it uses white lines) */}
      <div
        ...
        >
          {features.map((feat) => (
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-500">{feat.desc}</p>
            </motion.div>
          ))}
        </motion.div>
            ...
            <div className="rounded-xl bg-zinc-50 p-6 md:p-8 dark:bg-zinc-900/80">
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="mt-1 text-xs text-zinc-400 dark:text-zinc-500">INV-2603-042</div>
                </div>
